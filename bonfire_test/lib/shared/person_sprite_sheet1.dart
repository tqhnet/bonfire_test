...
class PersonSpritesheet {
  ...
  PersonSpritesheet({this.path = 'Warrior_Red.png',this.width = 196});
  ...
  Future<SpriteAnimation> get getIdleUp {
    return SpriteAnimation.load(
      ...
      SpriteAnimationData.sequenced(
        ...
        stepTime: 0.2,
        textureSize: Vector2.all(width),
        texturePosition: Vector2(0, width * 4),
      ),
    );
  }
  ...
  Future<SpriteAnimation> get getIdleDownRight {
    return SpriteAnimation.load(
      ...
      SpriteAnimationData.sequenced(
        ...
        stepTime: 0.2,
        textureSize: Vector2.all(width),
        texturePosition: Vector2(0, width * 1),
      ),
    );
  }
  ...
  get getRunRight {
    return SpriteAnimation.load(
      ...
      SpriteAnimationData.sequenced(
        ...
        stepTime: 0.2,
        textureSize: Vector2.all(width),
        texturePosition: Vector2(width, width),
      ),
    );
  }
